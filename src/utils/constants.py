...
DATA_OUTPUTS: Path = PROJECT_ROOT / "data" / "outputs"
OUTPUTS_PREDICTIONS: Path = DATA_OUTPUTS / "predictions"
OUTPUTS_MODELS: Path = DATA_OUTPUTS / "models"
BASELINE_LR_PREDICTIONS_PATH: Path = OUTPUTS_PREDICTIONS / "baseline_lr_predictions.parquet"
XGB_V1_PREDICTIONS_PATH: Path = OUTPUTS_PREDICTIONS / "xgb_v1_predictions.parquet"
XGB_V1_CALIBRATED_PREDICTIONS_PATH: Path = (
    OUTPUTS_PREDICTIONS / "xgb_v1_calibrated_predictions.parquet"
)
XGB_V1_FULL_MODEL_PATH: Path = OUTPUTS_MODELS / "xgb_v1_full.json"
CALIBRATION_PLOT_PATH: Path = DATA_OUTPUTS / "calibration_plot.png"
FEATURE_IMPORTANCE_LOG_DIR: Path = DATA_TRAINING / "feature_importance_log"
